...
import {SafeAreaView,Button,Dimensions,FlatList,ImageBackground,TouchableHighlight,Text } from "react-native";
...
const MainPage = ({navigation}) => {
    ...
    const dataSource = [
      ...
      function renderItem({item}){
          return (
              <TouchableHighlight onPress={() => navigation.navigate("Headlines",{
